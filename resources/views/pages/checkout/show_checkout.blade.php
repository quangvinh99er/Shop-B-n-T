...
<section id="cart_items">
    <div class="container">
        <div class="breadcrumbs">
            <ol class="breadcrumb">
                <li><a style="background-color: #3366CC" href="{{URL::to('/')}}">{{__('Trang chủ')}}</a></li>
                ...
                <form action="{{url('/update-cart')}}" method="POST">
                    ...
                    <table class="table table-condensed">
                        ...
                        <tbody>
                            ...
                            @endforeach
                            <tr>
                                <td><input type="submit" style="background-color: #3366CC" value="Cập nhật giỏ hàng" name="update_qty" class="check_out btn btn-default btn-sm"></td>
                                <td><a class="btn btn-default check_out" href="{{url('/del-all-product')}}" style="background-color: #3366CC">Xóa tất cả</a></td>
                                <td>
                        ...
                        <div class="col-sm-12 clearfix" >
                            <div class="bill-to">
                                ...
                                <form>
                                        ...
                                        <input type="button" value="Tính phí vận chuyển" name="calculate_order" style="background-color: #3366CC" class="btn btn-primary btn-sm calculate_delivery">
                                    ...
                                    <form action="{{URL::to('/save-checkout-customer')}}" method="POST">
                                        ...
                                        <input type="button" value="Xác nhận đơn hàng" name="send_order" style="background-color: #3366CC" class="btn btn-primary btn-sm send_order">
                                    </form>
