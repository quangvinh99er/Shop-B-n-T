  ...
  height: 39px; margin-top:-1px" src="{{asset('frontend/image/icon-ins.png')}}"></a></li>
                        ...
                        <div class="shop-menu pull-right">
                            ...
                            font-size: 10px;">
                                ...
                                ?>
                                    ...
                                    <li><a style="font-size: 18px; color: #3366CC" href="{{URL::to('/logout-checkout')}}"><?php echo $customer_name ?><i class="fa fa-lock"></i>Đăng xuất</a>
                                    </li>
                                <?php
                                } else {
                                ?>
                                    <li><a style="font-size: 18px; color: #3366CC" href="{{URL::to('/login-checkout')}}"><i class="fa fa-lock"></i>Đăng nhập</a>
                                    </li>
                                <?php
                                }
                                ?>
                    ...
                    <div class="col-sm-7">
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                <li class="intro"><a href="{{URL::to('/trangchu')}}" style="color: #3366CC">Trang chủ</a></li>

                                <li class="intro"><a style="color: #3366CC" href="{{URL::to('/tintuc')}}">Tin tức</i></a>
                                
                                </li>
                                <li class="intro"><a style="color: #3366CC" href="{{URL::to('/gio-hang')}}">Giỏ hàng</a></li>
                                <li class="intro"><a style="color: #3366CC" href="contact">Liên hệ</a></li>
            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="left-sidebar">
                        <h2 style="color: #3366CC">Danh mục sản phẩm</h2>
                        ...
                        <div class="brands_products">
                            <!--brands_products-->
                            <h2 style="color: #3366CC">Thương hiệu sản phẩm</h2>
    ...
    <footer id="footer">
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <p class="pull-right">Cửa hàng bán điện thoại di động <span><a target="_blank" href="" style="color: #3366CC">Huân Đạt Store</a></span></p>
                </div>
            </div>
        </div>
